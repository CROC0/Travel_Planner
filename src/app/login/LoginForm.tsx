    ...
    <main className="min-h-screen aurora-bg flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl glass box-glow-teal mb-6">
            <Plane className="w-8 h-8 text-[#00e5cc]" />
          </div>
        ...
        {/* Card */}
        <div className="glass rounded-2xl p-8 box-glow-teal">
